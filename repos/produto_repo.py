    ...
    def inserir_produtos_iniciais():
        with obter_conexao() as db:
            ...
            produtos_iniciais = [
                ...
                ("Abóbora", "Abóbora moranga de cor viva, perfeita para sopas, purês e receitas tradicionais.", 1.80, 90, 3),
                ("Abobrinha", "Abobrinha italiana fresca e saborosa, ótima para refogados, grelhados e saladas.", 2.20, 60, 3),
                ("Repolho", "Repolho verde crocante e versátil, ideal para saladas, cozidos ou refogados.", 1.10, 120, 2),
                ("Alho", "Alho fresco e aromático, essencial para temperar e realçar o sabor dos pratos.", 10.00, 20, 6)]
            for nome, descricao, preco, estoque, idcategoria in produtos_iniciais:
                cursor.execute(SQL_INSERIR, (nome, descricao, preco, estoque, idcategoria))
            db.commit()
